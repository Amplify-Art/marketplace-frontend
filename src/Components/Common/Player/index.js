...
function Player(props) {
  ...
  console.log('plalist',props.currentPlaylists)
  useEffect(() => {
  ...
  // const [currentPlaylists,setCurrentPlayList] = useState(props.currentPlaylists)
  console.log('props--',props.currentPlaylists[0].song_cid)
  ...
  useEffect(()=>{
    ...
    // setCurrentPlayList(props.currentPlaylists)
    setSongIndex(0)
    togglePlay(false)
    setSongSrc(`https://gateway.pinata.cloud/ipfs/${currentPlaylists[0].song_cid}`)
    ...
    (
      <div id="amplify-player" className={`amplify-player ${isExpanded && 'full'}`}>
        <div className="over">
          ...
          {console.log('current',currentPlaylists)}
